...
import { FinancieroService, NotaPedido, NotaPedidoDetalle } from '../../core/services/financiero.service';
...
<mat-dialog-content>
  <form [formGroup]="form" class="np-form">
    <mat-form-field appearance="outline" style="width:100%">
      ...
      <input matInput formControlName="areaSolicitante" />
    </mat-form-field>
    <mat-form-field appearance="outline" style="width:100%">
...
export class NotasPedidoComponent {
  ...
  cambiarEstado(n: NotaPedido, estado: string) {
