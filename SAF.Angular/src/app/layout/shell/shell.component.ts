  ...
  navSections: NavSection[] = [
    {
      ...
      items: [
        ...
        { label: 'Compromisos',     icon: 'handshake',        route: '/compromisos' },
        { label: 'Órdenes de Pago', icon: 'payments',         route: '/ordenes-pago' },
        { label: 'Facturas',        icon: 'receipt_long',     route: '/facturas' },
        { label: 'Proveedores',     icon: 'storefront',       route: '/proveedores' },
        { label: 'Notas de Pedido', icon: 'assignment',       route: '/notas-pedido' },
      ],
    },
  ];
}
