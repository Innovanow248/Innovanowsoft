...
[Authorize]
public class CompromisosController(ICompromisosRepository repo) : ControllerBase
{
    [HttpGet("{ano}")]
    ...
    [HttpPost("{ano}")]
    public async Task<IActionResult> Crear(string ano, [FromBody] NuevoCompromisoRequest req)
    {
